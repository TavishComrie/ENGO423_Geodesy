function NStokes60V3 = importfileTxt(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   NSTOKES60V3 = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   NSTOKES60V3 = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   NStokes60V3 = importfile('NStokes60V3', 2, 7921);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2024/04/08 12:31:41
...
formatSpec = '%8f%8f%8f%8f%8f%8f%8f%8f%8f%f%[^\n\r]';
...
NStokes60V3 = table(dataArray{1:end-1}, 'VariableNames', {'VarName1','VarName2','VarName3','VarName4','VarName5','VarName6','VarName7','VarName8','VarName9','VarName10'});
