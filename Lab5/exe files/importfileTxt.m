function NStokes = importfileTxt(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   NSTOKES = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   NSTOKES = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   NStokes = importfile('NStokes.txt', 2, 7921);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2024/04/02 16:27:33
